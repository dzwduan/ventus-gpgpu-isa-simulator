...
#define MATCH_VLW_GLOBAL_V 0x2076
#define MASK_VLW_GLOBAL_V 0x707f
#define MATCH_VLH_GLOBAL_V 0x1076
#define MASK_VLH_GLOBAL_V 0x707f
#define MATCH_VLHU_GLOBAL_V 0x5076
#define MASK_VLHU_GLOBAL_V 0x707f
#define MATCH_VLB_GLOBAL_V 0x76
#define MASK_VLB_GLOBAL_V 0x707f
#define MATCH_VLBU_GLOBAL_V 0x4076
#define MASK_VLBU_GLOBAL_V 0x707f
#define MATCH_VSW_GLOBAL_V 0x6076
#define MASK_VSW_GLOBAL_V 0x707f
#define MATCH_VSH_GLOBAL_V 0x3076
#define MASK_VSH_GLOBAL_V 0x707f
#define MATCH_VSB_GLOBAL_V 0x7076
#define MASK_VSB_GLOBAL_V 0x707f

#define MATCH_VLW_LOCAL_V 0x207a
#define MASK_VLW_LOCAL_V 0x707f
#define MATCH_VLH_LOCAL_V 0x107a
#define MASK_VLH_LOCAL_V 0x707f
#define MATCH_VLHU_LOCAL_V 0x507a
#define MASK_VLHU_LOCAL_V 0x707f
#define MATCH_VLB_LOCAL_V 0x7a
#define MASK_VLB_LOCAL_V 0x707f
#define MATCH_VLBU_LOCAL_V 0x407a
#define MASK_VLBU_LOCAL_V 0x707f
#define MATCH_VSW_LOCAL_V 0x607a
#define MASK_VSW_LOCAL_V 0x707f
#define MATCH_VSH_LOCAL_V 0x307a
#define MASK_VSH_LOCAL_V 0x707f
#define MATCH_VSB_LOCAL_V 0x707a
#define MASK_VSB_LOCAL_V 0x707f

#define MATCH_VLW_PRIVATE_V 0x207e
#define MASK_VLW_PRIVATE_V 0x707f
#define MATCH_VLH_PRIVATE_V 0x107e
#define MASK_VLH_PRIVATE_V 0x707f
#define MATCH_VLHU_PRIVATE_V 0x507e
#define MASK_VLHU_PRIVATE_V 0x707f
#define MATCH_VLB_PRIVATE_V 0x7e
#define MASK_VLB_PRIVATE_V 0x707f
#define MATCH_VLBU_PRIVATE_V 0x407e
#define MASK_VLBU_PRIVATE_V 0x707f
#define MATCH_VSW_PRIVATE_V 0x607e
#define MASK_VSW_PRIVATE_V 0x707f
#define MATCH_VSH_PRIVATE_V 0x307e
#define MASK_VSH_PRIVATE_V 0x707f
#define MATCH_VSB_PRIVATE_V 0x707e
#define MASK_VSB_PRIVATE_V 0x707f
...
DECLARE_INSN(vlw_global_v, MATCH_VLW_GLOBAL_V, MASK_VLW_GLOBAL_V)
DECLARE_INSN(vlh_global_v, MATCH_VLH_GLOBAL_V, MASK_VLH_GLOBAL_V)
DECLARE_INSN(vlb_global_v, MATCH_VLB_GLOBAL_V, MASK_VLB_GLOBAL_V)
DECLARE_INSN(vlbu_global_v, MATCH_VLBU_GLOBAL_V, MASK_VLBU_GLOBAL_V)
DECLARE_INSN(vlhu_global_v, MATCH_VLHU_GLOBAL_V, MASK_VLHU_GLOBAL_V)
DECLARE_INSN(vsw_global_v, MATCH_VSW_GLOBAL_V, MASK_VSW_GLOBAL_V)
DECLARE_INSN(vsh_global_v, MATCH_VSH_GLOBAL_V, MASK_VSH_GLOBAL_V)
DECLARE_INSN(vsb_global_v, MATCH_VSB_GLOBAL_V, MASK_VSB_GLOBAL_V)
DECLARE_INSN(vlw_local_v, MATCH_VLW_LOCAL_V, MASK_VLW_LOCAL_V)
DECLARE_INSN(vlh_local_v, MATCH_VLH_LOCAL_V, MASK_VLH_LOCAL_V)
DECLARE_INSN(vlb_local_v, MATCH_VLB_LOCAL_V, MASK_VLB_LOCAL_V)
DECLARE_INSN(vlbu_local_v, MATCH_VLBU_LOCAL_V, MASK_VLBU_LOCAL_V)
DECLARE_INSN(vlhu_local_v, MATCH_VLHU_LOCAL_V, MASK_VLHU_LOCAL_V)
DECLARE_INSN(vsw_local_v, MATCH_VSW_LOCAL_V, MASK_VSW_LOCAL_V)
DECLARE_INSN(vsh_local_v, MATCH_VSH_LOCAL_V, MASK_VSH_LOCAL_V)
DECLARE_INSN(vsb_local_v, MATCH_VSB_LOCAL_V, MASK_VSB_LOCAL_V)
DECLARE_INSN(vlw_private_v, MATCH_VLW_PRIVATE_V, MASK_VLW_PRIVATE_V)
DECLARE_INSN(vlh_private_v, MATCH_VLH_PRIVATE_V, MASK_VLH_PRIVATE_V)
DECLARE_INSN(vlb_private_v, MATCH_VLB_PRIVATE_V, MASK_VLB_PRIVATE_V)
DECLARE_INSN(vlbu_private_v, MATCH_VLBU_PRIVATE_V, MASK_VLBU_PRIVATE_V)
DECLARE_INSN(vlhu_private_v, MATCH_VLHU_PRIVATE_V, MASK_VLHU_PRIVATE_V)
DECLARE_INSN(vsw_private_v, MATCH_VSW_PRIVATE_V, MASK_VSW_PRIVATE_V)
DECLARE_INSN(vsh_private_v, MATCH_VSH_PRIVATE_V, MASK_VSH_PRIVATE_V)
DECLARE_INSN(vsb_private_v, MATCH_VSB_PRIVATE_V, MASK_VSB_PRIVATE_V)
