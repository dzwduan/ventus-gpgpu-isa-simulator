...
// rvv-gpgpu custumed instructions
#define MATCH_BARRIER 0x400400b
#define MASK_BARRIER 0xfe00707f
#define MATCH_BARRIERSUB 0x600400b
#define MASK_BARRIERSUB 0xfe00707f
#define MATCH_ENDPRG 0x400b
#define MASK_ENDPRG 0xfe00707f
#define MATCH_JOIN 0x205b
#define MASK_JOIN 0x707f
#define MATCH_SETRPC 0x305b
#define MASK_SETRPC 0x707f
#define MATCH_REGEXT 0x200b
#define MASK_REGEXT 0x707f
#define MATCH_REGEXTI 0x300b
#define MASK_REGEXTI 0x707f
#define MATCH_VADD12_VI 0xb
#define MASK_VADD12_VI 0x707f
#define MATCH_VBEQ 0x5b
#define MASK_VBEQ 0x707f
#define MATCH_VBGE 0x505b
#define MASK_VBGE 0x707f
#define MATCH_VBGEU 0x705b
#define MASK_VBGEU 0x707f
#define MATCH_VBLT 0x405b
#define MASK_VBLT 0x707f
#define MATCH_VBLTU 0x605b
#define MASK_VBLTU 0x707f
#define MATCH_VBNE 0x105b
#define MASK_VBNE 0x707f
#define MATCH_VLB12_V 0x7b
#define MASK_VLB12_V 0x707f
#define MATCH_VLB_V 0x2b
#define MASK_VLB_V 0x8000707f
#define MATCH_VLBU12_V 0x407b
#define MASK_VLBU12_V 0x707f
#define MATCH_VLBU_V 0x402b
#define MASK_VLBU_V 0x8000707f
#define MATCH_VLH12_V 0x107b
#define MASK_VLH12_V 0x707f
#define MATCH_VLH_V 0x102b
#define MASK_VLH_V 0x8000707f
#define MATCH_VLHU12_V 0x507b
#define MASK_VLHU12_V 0x707f
#define MATCH_VLHU_V 0x502b
#define MASK_VLHU_V 0x8000707f
#define MATCH_VLW12_V 0x207b
#define MASK_VLW12_V 0x707f
#define MATCH_VLW_V 0x202b
#define MASK_VLW_V 0x8000707f
#define MATCH_VSB12_V 0x707b
#define MASK_VSB12_V 0x707f
#define MATCH_VSB_V 0x8000002b
#define MASK_VSB_V 0x8000707f
#define MATCH_VSH12_V 0x307b
#define MASK_VSH12_V 0x707f
#define MATCH_VSH_V 0x8000102b
#define MASK_VSH_V 0x8000707f
#define MATCH_VSUB12_VI 0x100b
#define MASK_VSUB12_VI 0x707f
#define MATCH_VSW12_V 0x607b
#define MASK_VSW12_V 0x707f
#define MATCH_VSW_V 0x8000202b
#define MASK_VSW_V 0x8000707f
#define MATCH_VFTTA_VV 0xc00400b
#define MASK_VFTTA_VV 0xfc00707f
#define MATCH_VFEXP_V 0x800600b
#define MASK_VFEXP_V 0xfc0ff07f

#define MATCH_VADD64_VV 0x54ULL
#define MASK_VADD64_VV  0xfc0000000000387fULL
#define MATCH_VSUB64_VV 0x0800000000000054ULL
#define MASK_VSUB64_VV  0xfc0000000000387fULL
#define MATCH_VMIN64_VV 0x1400000000000054ULL
#define MASK_VMIN64_VV  0xfc0000000000387fULL
#define MATCH_VMAX64_VV 0x1c00000000000054ULL
#define MASK_VMAX64_VV  0xfc0000000000387fULL
#define MATCH_VMUL64_VV 0x9400000000000054ULL
#define MASK_VMUL64_VV  0xfc0000000000387fULL

#define MATCH_VMINU64_VV 0x1000000000000054ULL
#define MASK_VMINU64_VV  0xfc0000000000387fULL
#define MATCH_VMAXU64_VV 0x1800000000000054ULL
#define MASK_VMAXU64_VV  0xfc0000000000387fULL

#define MATCH_VADD64_VX 0x2054ULL
#define MASK_VADD64_VX  0xfc0000000000387fULL
#define MATCH_VSUB64_VX 0x0800000000002054ULL
#define MASK_VSUB64_VX  0xfc0000000000387fULL
#define MATCH_VMIN64_VX 0x1400000000002054ULL
#define MASK_VMIN64_VX  0xfc0000000000387fULL
#define MATCH_VMAX64_VX 0x1c00000000002054ULL
#define MASK_VMAX64_VX  0xfc0000000000387fULL
#define MATCH_VMUL64_VX 0x9400000000002054ULL
#define MASK_VMUL64_VX  0xfc0000000000387fULL

#define MATCH_VMINU64_VX 0x1000000000002054ULL
#define MASK_VMINU64_VX  0xfc0000000000387fULL
#define MATCH_VMAXU64_VX 0x1800000000002054ULL
#define MASK_VMAXU64_VX  0xfc0000000000387fULL

#define MATCH_VFADD64_VV 0x854ULL
#define MASK_VFADD64_VV  0xfc0000000000387fULL
#define MATCH_VFSUB64_VV 0x0800000000000854ULL
#define MASK_VFSUB64_VV  0xfc0000000000387fULL
#define MATCH_VFMIN64_VV 0x1000000000000854ULL
#define MASK_VFMIN64_VV  0xfc0000000000387fULL
#define MATCH_VFMAX64_VV 0x1800000000000854ULL
#define MASK_VFMAX64_VV  0xfc0000000000387fULL
#define MATCH_VFMUL64_VV 0x9000000000000854ULL
#define MASK_VFMUL64_VV  0xfc0000000000387fULL

#define MATCH_VFADD64_VF 0x2854ULL
#define MASK_VFADD64_VF  0xfc0000000000387fULL
#define MATCH_VFSUB64_VF 0x0800000000002854ULL
#define MASK_VFSUB64_VF  0xfc0000000000387fULL
#define MATCH_VFMIN64_VF 0x1000000000002854ULL
#define MASK_VFMIN64_VF  0xfc0000000000387fULL
#define MATCH_VFMAX64_VF 0x1800000000002854ULL
#define MASK_VFMAX64_VF  0xfc0000000000387fULL
#define MATCH_VFMUL64_VF 0x9000000000002854ULL
#define MASK_VFMUL64_VF  0xfc0000000000387fULL
...
// rvv-gpgpu custumed instruction 
DECLARE_INSN(barrier, MATCH_BARRIER, MASK_BARRIER)
DECLARE_INSN(barriersub, MATCH_BARRIERSUB, MASK_BARRIERSUB)
DECLARE_INSN(endprg, MATCH_ENDPRG, MASK_ENDPRG)
DECLARE_INSN(join, MATCH_JOIN, MASK_JOIN)
DECLARE_INSN(setrpc, MATCH_SETRPC, MASK_SETRPC)
DECLARE_INSN(regext, MATCH_REGEXT, MASK_REGEXT)
DECLARE_INSN(regexti, MATCH_REGEXTI, MASK_REGEXTI)
DECLARE_INSN(vadd12_vi, MATCH_VADD12_VI, MASK_VADD12_VI)
DECLARE_INSN(vbeq, MATCH_VBEQ, MASK_VBEQ)
DECLARE_INSN(vbge, MATCH_VBGE, MASK_VBGE)
DECLARE_INSN(vbgeu, MATCH_VBGEU, MASK_VBGEU)
DECLARE_INSN(vblt, MATCH_VBLT, MASK_VBLT)
DECLARE_INSN(vbltu, MATCH_VBLTU, MASK_VBLTU)
DECLARE_INSN(vbne, MATCH_VBNE, MASK_VBNE)
DECLARE_INSN(vlb12_v, MATCH_VLB12_V, MASK_VLB12_V)
DECLARE_INSN(vlb_v, MATCH_VLB_V, MASK_VLB_V)
DECLARE_INSN(vlbu12_v, MATCH_VLBU12_V, MASK_VLBU12_V)
DECLARE_INSN(vlbu_v, MATCH_VLBU_V, MASK_VLBU_V)
DECLARE_INSN(vlh12_v, MATCH_VLH12_V, MASK_VLH12_V)
DECLARE_INSN(vlh_v, MATCH_VLH_V, MASK_VLH_V)
DECLARE_INSN(vlhu12_v, MATCH_VLHU12_V, MASK_VLHU12_V)
DECLARE_INSN(vlhu_v, MATCH_VLHU_V, MASK_VLHU_V)
DECLARE_INSN(vlw12_v, MATCH_VLW12_V, MASK_VLW12_V)
DECLARE_INSN(vlw_v, MATCH_VLW_V, MASK_VLW_V)
DECLARE_INSN(vsb12_v, MATCH_VSB12_V, MASK_VSB12_V)
DECLARE_INSN(vsb_v, MATCH_VSB_V, MASK_VSB_V)
DECLARE_INSN(vsh12_v, MATCH_VSH12_V, MASK_VSH12_V)
DECLARE_INSN(vsh_v, MATCH_VSH_V, MASK_VSH_V)
DECLARE_INSN(vsub12_vi, MATCH_VSUB12_VI, MASK_VSUB12_VI)
DECLARE_INSN(vsw12_v, MATCH_VSW12_V, MASK_VSW12_V)
DECLARE_INSN(vsw_v, MATCH_VSW_V, MASK_VSW_V)
DECLARE_INSN(vftta_vv, MATCH_VFTTA_VV, MASK_VFTTA_VV)
DECLARE_INSN(vfexp_v, MATCH_VFEXP_V, MASK_VFEXP_V)

DECLARE_INSN(vadd64_vv, MATCH_VADD64_VV, MASK_VADD64_VV)
DECLARE_INSN(vsub64_vv, MATCH_VSUB64_VV, MASK_VSUB64_VV)
DECLARE_INSN(vmin64_vv, MATCH_VMIN64_VV, MASK_VMIN64_VV)
DECLARE_INSN(vmax64_vv, MATCH_VMAX64_VV, MASK_VMAX64_VV)
DECLARE_INSN(vmul64_vv, MATCH_VMUL64_VV, MASK_VMUL64_VV)

DECLARE_INSN(vminu64_vv, MATCH_VMINU64_VV, MASK_VMINU64_VV)
DECLARE_INSN(vmaxu64_vv, MATCH_VMAXU64_VV, MASK_VMAXU64_VV)

DECLARE_INSN(vadd64_vx, MATCH_VADD64_VX, MASK_VADD64_VX)
DECLARE_INSN(vsub64_vx, MATCH_VSUB64_VX, MASK_VSUB64_VX)
DECLARE_INSN(vmin64_vx, MATCH_VMIN64_VX, MASK_VMIN64_VX)
DECLARE_INSN(vmax64_vx, MATCH_VMAX64_VX, MASK_VMAX64_VX)
DECLARE_INSN(vmul64_vx, MATCH_VMUL64_VX, MASK_VMUL64_VX)

DECLARE_INSN(vminu64_vx, MATCH_VMINU64_VX, MASK_VMINU64_VX)
DECLARE_INSN(vmaxu64_vx, MATCH_VMAXU64_VX, MASK_VMAXU64_VX)

DECLARE_INSN(vfadd64_vv, MATCH_VFADD64_VV, MASK_VFADD64_VV)
DECLARE_INSN(vfsub64_vv, MATCH_VFSUB64_VV, MASK_VFSUB64_VV)
DECLARE_INSN(vfmin64_vv, MATCH_VFMIN64_VV, MASK_VFMIN64_VV)
DECLARE_INSN(vfmax64_vv, MATCH_VFMAX64_VV, MASK_VFMAX64_VV)
DECLARE_INSN(vfmul64_vv, MATCH_VFMUL64_VV, MASK_VFMUL64_VV)

DECLARE_INSN(vfadd64_vf, MATCH_VFADD64_VF, MASK_VFADD64_VF)
DECLARE_INSN(vfsub64_vf, MATCH_VFSUB64_VF, MASK_VFSUB64_VF)
DECLARE_INSN(vfmin64_vf, MATCH_VFMIN64_VF, MASK_VFMIN64_VF)
DECLARE_INSN(vfmax64_vf, MATCH_VFMAX64_VF, MASK_VFMAX64_VF)
DECLARE_INSN(vfmul64_vf, MATCH_VFMUL64_VF, MASK_VFMUL64_VF)
...
DECLARE_CSR(numw, CSR_NUMW)
DECLARE_CSR(numt, CSR_NUMT)
DECLARE_CSR(knl, CSR_KNL)
DECLARE_CSR(wgid, CSR_WGID)
DECLARE_CSR(wid, CSR_WID)
DECLARE_CSR(lds, CSR_LDS)
DECLARE_CSR(pds, CSR_PDS)
DECLARE_CSR(gidx, CSR_GIDX)
DECLARE_CSR(gidy, CSR_GIDY)
DECLARE_CSR(gidz, CSR_GIDZ)
DECLARE_CSR(clprintf, CSR_PRINT)
DECLARE_CSR(rpc, CSR_RPC)
#endif
#ifdef DECLARE_CAUSE
